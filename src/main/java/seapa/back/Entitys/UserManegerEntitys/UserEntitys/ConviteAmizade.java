...
@NamedQueries(value = {
        @NamedQuery(name = ConviteAmizade.FIND_ALL_CONVITES_PENDENTES_BY_SOLICITADO_ID, query = ConviteAmizade.FIND_ALL_CONVITES_PENDENTES_BY_SOLICITADO_ID)
})
...
public class ConviteAmizade implements Serializable {
    ...
    public static final String FIND_ALL_CONVITES_PENDENTES_BY_SOLICITADO_ID = "SELECT ca FROM ConviteAmizade ca WHERE ca.solicitado.id = :solicitadoId AND ca.statusConvite = 'PENDENTE'";
